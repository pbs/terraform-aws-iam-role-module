...
```hcl
module "iam_role" {
    source = "github.com/pbs/terraform-aws-iam-role-module?ref=0.0.2"
}
```
...
| <a name="input_product"></a> [product](#input\_product) | Tag used to group resources according to application | `string` | n/a | yes |
